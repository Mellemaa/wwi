...
$review_tekst = filter_input(INPUT_POST, "Review");
$review_cijfer = filter_input(INPUT_POST, "Cijfer");


$connection = getConnection();
$rev = $connection->prepare("INSERT INTO Review (tekst, cijfer) VALUES ('$review_tekst', '$review_cijfer");
$rev->execute();
...
<!--Review box--> 
                        ...
                        <div class="row" id="review-box">
                            <div class="col-md-12">
                                <form action="html.html.php" method="get">
